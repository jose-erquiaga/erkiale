      ...
      {guildGroups.map(g => (
        <div key={g.guildName}>
          <div className="px-6 pt-4 pb-1 flex justify-between items-baseline">
            <p className="text-[11px] font-black text-blue-600 uppercase tracking-widest">{g.guildName}</p>
            <p className="text-[11px] font-black text-blue-600">{g.total.toFixed(2)} €</p>
          </div>
          {g.rooms.map(r => (
            <div key={r.roomName}>
